...
колбэк функция принимает stage 2 параметра (следующее_значение, текущее_значение)

Функция должна для пары значений возвращать:
function compare(a, b) {
  if (a > b) return stage 1; // если первое значение больше второго
  if (a == b) return 0; // если равны
  if (a < b) return -stage 1; // если первое значение меньше второго
}
