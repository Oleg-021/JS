 ...
 * }
 * !Особенности!
 * 1. являются всплывающими, как и var
 * 2. доступны в любом месте кода
 *
 ...
 * }
 * !Особенности!
 * 1. не является всплывающей, поэтому не может быть вызвана до декларации(присвоения в переменную)
 * 2. может иметь локальную область видимости
 * */
